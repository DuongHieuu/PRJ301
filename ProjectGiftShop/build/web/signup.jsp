        ...
        <div class="login_signup">
            <div class="form">
                <form class="signup_form" action="signup" method="post">
                    ...
                    <input type="Confirm" placeholder="reenter password" name="repassword" pattern=".{3,16}" title="Password must have at least 3 characters and max 16 characters."  required />
